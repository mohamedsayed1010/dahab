...
export const ROUTE_META = {
  ...
  "/terms": page(
    "الشروط والأحكام",
    "الشروط والأحكام الخاصة باستخدام تطبيق دهب العربي لعرض أسعار الذهب والفضة."
  ),
  "/privacy": page(
    "سياسة الخصوصية",
    "سياسة الخصوصية لتطبيق دهب العربي: البيانات التي نجمعها وكيفية استخدامها وحمايتها."
  ),
  "/delete-account": page(
    "حذف الحساب",
    "طريقة حذف حسابك في تطبيق دهب العربي نهائياً: أدخل الاسم ورقم الهاتف المسجَّلين بالحساب، وتعرَّف على البيانات التي يتم حذفها."
  ),
